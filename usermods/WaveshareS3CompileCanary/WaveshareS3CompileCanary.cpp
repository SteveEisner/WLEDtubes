...
class WaveshareS3TubesPrototype : public Usermod {
  private:
    ...
    // Probes a board-local I2C address without changing peripheral state.
    ...
    void drawPreview() {
      ...
      for (uint16_t index = 0; index < count; index++) {
        ...
        display.fillRoundRect(x, y, cell, cell, 4, toRgb565(bus->getPixelColor(index)));
      }
    }
  ...
  public:
    ...
    void setup() override {
      ...
      powerMonitorPresent = i2cPresent(0x34);
      imuPresent = i2cPresent(0x6B);
