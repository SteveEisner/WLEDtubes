...
| `Q` | Open a 20-second propagation-source window. Double-click one nearby capable tube to make it serve its already-running verified image; this never enters `WLED-UPDATE` selection. |
