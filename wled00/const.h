...
#ifdef USERMOD_TUBES
constexpr size_t GRADIENT_PALETTE_COUNT = 116; // 13-129 = sizeof(gGradientPalettes) / sizeof(gGradientPalettes[0]);
#else
...
#define USERMOD_ID_TUBES                 59     //Usermod "Tubes"
...
#define TYPE_TUBES_NULL          96            // internal geometry-only sink, never a transport
#endif
...
// A board environment may provide its safe first-boot length. Generic builds
// retain 30 LEDs when no hardware-specific default was selected.
