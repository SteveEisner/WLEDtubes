...
// Geometry-only sink for the S3 observer target; it owns no buffer or pins.
class BusTubesNull : public Bus {
  public:
    BusTubesNull(const BusConfig &bc);
    void show() override {}
    void setPixelColor(unsigned pix, uint32_t c) override {}
    uint32_t getPixelColor(unsigned pix) const override { return 0; }
};
// AI: end
#endif
...
namespace BusManager {
  ...
  // AI: below section was generated by an AI
  inline bool     isABLActive()                 { return _useABL; }
  // AI: end
