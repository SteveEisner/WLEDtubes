...
void WLED::beginStrip()
{
  ...
  // Initialize the relay once after resolving the boot state. Forcing it off first
  // power-cycles relay-controlled LED hardware whenever WLED starts in the on state.
  if (rlyPin >= 0) {
